...
public class Bouffon extends Role {
    ...
    public void onVoteEnd(VoteEndEvent ev) {
        ...
        if (ev.getVote().getName().equals("Vote du Village") && choosen != null && choosen.getRole() instanceof Bouffon) {
            ...
            Bukkit.getScheduler().runTaskLater(LG.getInstance(), () -> Bukkit.broadcastMessage(LG.getPrefix() + "§aLe " + Bouffon.this.getDisplayName() + "§d " + ev.getChoosen().getName() + "§aa réussi son objectif !"), 1L);
        }
    }
