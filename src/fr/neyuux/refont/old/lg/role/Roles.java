package fr.neyuux.refont.old.lg.role;
...
public enum Roles {
	...
	COMÉDIEN("Comédien", "§5§lComédien", "§fVous êtes §5§lComédien§f, votre but est d'éliminer tous les §c§lLoups-Garous§f (ou rôles solos). Au début de la partie, vous obtiendrez §93 pouvoirs de rôles villageois§f que vous pourrez utiliser une fois chacun pendant la partie.", RDeck.LOUP_GAROU_DE_THIERCELIEUX, RCamp.VILLAGE),
	SERVANTE_DÉVOUÉE("Servante Dévouée", "§d§lServante §5Dévouée", "§fVous êtes §d§lServante §5Dévouée§f, vous n'avez pas réellement d'objectif. Pendant la partie : lorsque quelqu'un mourra au vote, vous aurez 10 secondes pour choisir de §9prendre son rôle§f ou non. (Vous deviendrez donc le rôle que ce joueur incarnait)", RDeck.LOUP_GAROU_DE_THIERCELIEUX, RCamp.VILLAGE),
	JOUEUR_DE_FLÛTE("Joueur de Flûte", "§5§lJoueur de Flûte", "§fVous êtes §5§lJoueur de Flûte§f, votre objectif est de gagner la partie (wow). Vous pouvez remporter celle-ci en §9enchantant tous les joueurs§f avec votre flûte. Chaque nuit, vous pouvez enchanter jusqu'à 2 personnes.", RDeck.LOUP_GAROU_DE_THIERCELIEUX, RCamp.JOUEUR_DE_FLÛTE),
	...
	BOUC_ÉMISSAIRE("Bouc Émissaire", "§c§lBouc §a§lÉmissaire", "§fVous êtes §c§lBouc §a§lÉmissaire§f, votre but est d'éliminer tous les §c§lLoups-Garous§f (ou rôles solos). Si, pendant la partie, il y a égalité dans les votes, §9vous mourrez§f. (§8§l§n§m§oGROSSE VICTIME§f)", RDeck.LOUP_GAROU_DE_THIERCELIEUX, RCamp.VILLAGE),
	...
	FRÈRE("Frère", "§3§lFrère", "§fVous êtes §3§lFrère§f, votre but est d'éliminer tous les §c§lLoups-Garous §f(ou rôles solos). Pendant la partie, vos deux frères seront vos coéquipiers, vous pouvez donc §9leur faire confiance§f.", RDeck.LOUP_GAROU_DE_THIERCELIEUX, RCamp.VILLAGE),
	...
	CHEVALIER_À_L$ÉPÉE_ROUILLÉE("Chevalier a l'Épée Rouillée", "§7§lChevalier §eà l'§7Épée §6§lRouillée", "§fVous êtes §7§lChevalier §eà l'§7Épée §6§lRouillée§f, votre but est d'éliminer tous les §c§lLoups-Garous §f(ou rôles solos). Si vous mourrez par les loups, le premier Loup à votre gauche§o(réunion)§f ou en dessous dans le tab§o(libre)§f tombera gravement malade : §9il mourra§f au tour suivant.", RDeck.LOUP_GAROU_DE_THIERCELIEUX, RCamp.VILLAGE),
	...
	DÉTECTIVE("Détective", "§7§lDétective", "§fVous êtes §7§lDétective§f, votre but est d'éliminer les §c§lLoups-Garous §f(ou rôles solos). Chaque nuit, vous serez appelé pour §9enquêter§f sur deux joueurs : vous saurez s'ils sont du même camp ou non.", RDeck.WEREWOLF_ONLINE, RCamp.VILLAGE),
	DUR_À_CUIRE("Dur à Cuire", "§c§lDur §cà §6§lCuire", "§fVous êtes §c§lDur à §6§lCuire§f, votre but est d'éliminer les §c§lLoups-Garous §f(ou rôles solos). Lorque les Loups voudront vous tuer, vous survivrez jusqu'au jour suivant.", RDeck.WEREWOLF_ONLINE, RCamp.VILLAGE),
	...
	MAÇON("Maçon", "§6§lMaçon", "§fVous êtes §6§lMaçon§f, votre but est d'éliminer les §c§lLoups-Garous §f(ou rôles solos). Vous et les autres §6§lMaçons§f vous reconnaissez entre-vous §8(car vous vous appellez tous Ricardo)§f ; vous pouvez donc avoir confiance en eux.", RDeck.WEREWOLF_ONLINE, RCamp.VILLAGE),
	NÉCROMANCIEN("Nécromancien", "§9§lNécromancien", "§fVous êtes §9§lNégromancien§f, votre but est d'éliminer les §c§lLoups-Garous §f(ou rôles solos). Une fois dans la partie, vous pourrez §9récussiter§f un joueur. S'il avait un pouvoir, il le perd et devient §e§lSimple §a§lVillageois§f.", RDeck.WEREWOLF_ONLINE, RCamp.VILLAGE),
	...
	PRÉSIDENT("Président", "§e§lPrésident", "§fVous êtes §e§lPrésident§f, votre but est d'éliminer les §c§lLoups-Garous §f(ou rôles solos). Tous le monde connait votre identité, mais si vous mourrez, le §9village a perdu§f. Vous possédez également le rôle de maire s'il est activé.", RDeck.WEREWOLF_ONLINE, RCamp.VILLAGE),
	PRÊTRE("Prêtre", "§e§lP§f§lr§e§lê§f§lt§e§lr§f§le", "§fVous êtes §e§lP§f§lr§e§lê§f§lt§e§lr§f§le, votre but est d'éliminer les §c§lLoups-Garous §f(ou rôles solos). Vous possédez une fiole d'eau bénite et chaque nuit, vous pourrez choisir de l'utiliser en ciblant un joueur : si vous le faites, si ce joueur est Loup, il §9mourra§f sinon, vous mourrez.", RDeck.WEREWOLF_ONLINE, RCamp.VILLAGE),
	...
	VILAIN_GARÇON("Vilain Garçon", "§c§lVilain §b§lGarçon", "§fVous êtes §c§lVilain §b§lGarçon§f, votre but est d'éliminer les §c§lLoups-Garous §f(ou rôles solos). Une fois dans la partie, vous pourrez échanger les rôles de deux personnes.", RDeck.WEREWOLF_ONLINE, RCamp.VILLAGE),
	...
	public static Roles getByDisplayName(String displayname) {
		...
		for (Roles roles : Roles.values()) {
			if (roles.getDisplayName().equals(displayname)) r = roles;
		}
